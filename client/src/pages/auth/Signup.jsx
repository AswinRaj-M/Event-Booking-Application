            ...
            <div className="hidden lg:flex lg:w-1/2 relative overflow-hidden bg-black">
                ...
                <div className="relative z-10 flex flex-col justify-end p-12 w-full h-full">
                    ...
                    <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-white/10 backdrop-blur-md border border-white/10 w-fit mb-6">
                        ...
                        <span className="text-xs font-medium tracking-wide text-white/90">Live Events</span>
                    </div>
                    ...
                    <h1 className="text-5xl md:text-6xl font-bold leading-tight mb-4 tracking-tight text-white drop-shadow-2xl">
                        ...
                        <span className="text-transparent bg-clip-text bg-gradient-to-r from-purple-400 via-pink-400 to-red-400 drop-shadow-lg">Event</span> <span className="text-transparent bg-clip-text bg-gradient-to-r from-red-400 via-purple-400 to-indigo-400 drop-shadow-lg">Experience</span>
                    </h1>

                    <p className="text-lg text-gray-200 max-w-lg mb-8 leading-relaxed drop-shadow-md">
                        Create an account today to unlock exclusive access to concerts, festivals, and nightlife events. Start booking unforgettable moments.
                    </p>
                    ...
                    <div className="flex items-center gap-4">
                        ...
                        <div>
                            <p className="text-sm font-semibold text-white">2,000+ events joined this week</p>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div className="w-full max-w-md bg-black/40 backdrop-blur-xl border border-white/10 rounded-2xl p-8 shadow-2xl relative z-10">
                    ...
                    <div className="space-y-5">
                        <div className="space-y-1 text-center">
                            ...
                            <p className="text-sm text-gray-400">Sign up to discover and book amazing events</p>
                        </div>

                        <form className="space-y-3">
                            {/* Full Name */}
                            <div className="space-y-1">
                                <label className="text-xs font-medium text-gray-300 ml-1" htmlFor="fullName">Full Name</label>
                            ...
                            {/* Email */}
                            <div className="space-y-1">
                                <label className="text-xs font-medium text-gray-300 ml-1" htmlFor="email">Email Address</label>
                                <div className="relative group">
                                    <input
                                        id="email"
                                        type="email"
                            ...
                            {/* Phone Number */}
                            <div className="space-y-1">
                                <label className="text-xs font-medium text-gray-300 ml-1" htmlFor="phone">Phone Number</label>
                                <div className="relative group">
                                    <input
                                        id="phone"
                                        type="tel"
                            ...
                            <div className="grid grid-cols-2 gap-3">
                                ...
                                {/* Confirm Password */}
                                <div className="space-y-1">
                                    <label className="text-xs font-medium text-gray-300 ml-1" htmlFor="confirmPassword">Confirm</label>
                                    <div className="relative group">
                                        <input
                                            id="confirmPassword"
                            ...
                            <div className="flex items-start gap-2 pt-1">
                                <input
                                    ...
                                    onChange={handleChange}
                                />
                                <label htmlFor="agreeToTerms" className="text-xs text-gray-400 cursor-pointer select-none">
                                    I agree to the <span className="text-purple-400 hover:text-purple-300 transition-colors">Terms of Service</span> & <span className="text-purple-400 hover:text-purple-300 transition-colors">Privacy Policy</span>
                                </label>
                            </div>
                        ...
                        <div className="grid grid-cols-2 gap-3">
                            <button className="flex items-center justify-center gap-2 px-4 py-2.5 bg-[#121212] hover:bg-[#1a1a1a] border border-gray-800 rounded-xl transition-colors group">
                                ...
                                <span className="text-xs font-medium text-gray-300 group-hover:text-white">Google</span>
                            </button>
                            <button className="flex items-center justify-center gap-2 px-4 py-2.5 bg-[#121212] hover:bg-[#1a1a1a] border border-gray-800 rounded-xl transition-colors group">
                                {/* Apple Icon */}
                                ...
                                <span className="text-xs font-medium text-gray-300 group-hover:text-white">Apple</span>
                            </button>
                        </div>
                    </div>
                </div>
