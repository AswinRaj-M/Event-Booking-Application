      ...
      <div className="hidden lg:flex lg:w-1/2 relative overflow-hidden bg-black">
        ...
        <div className="relative z-10 flex flex-col justify-end p-12 w-full h-full">
          ...
          <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-white/10 backdrop-blur-md border border-white/10 w-fit mb-6">
            ...
            <span className="text-xs font-medium tracking-wide text-white/90">Live Events Near You</span>
          </div>
          ...
          <h1 className="text-5xl md:text-6xl font-bold leading-tight mb-4 tracking-tight text-white drop-shadow-2xl">
            Welcome Back to <br />
            the <span className="text-transparent bg-clip-text bg-gradient-to-r from-purple-400 via-pink-400 to-red-400 drop-shadow-lg">Event</span> <br />
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-red-400 via-purple-400 to-indigo-400 drop-shadow-lg">Experience</span>
          </h1>

          <p className="text-lg text-gray-200 max-w-lg mb-8 leading-relaxed drop-shadow-md">
            Discover the best concerts, parties, and exclusive gatherings.
            Book your spot, celebrate with friends, and create memories that last forever.
          </p>
          ...
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-xs text-gray-400">Trusted by event goers worldwide</p>
            </div>
          </div>
        </div>
      </div>
        ...
        <div className="w-full max-w-md bg-black/40 backdrop-blur-xl border border-white/10 rounded-2xl p-8 shadow-2xl relative z-10">
          ...
          <div className="space-y-5">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <button
                type="submit"
                className="w-full py-3.5 px-4 bg-gradient-to-r from-primary to-violet-600 hover:from-violet-600 hover:to-primary text-white font-medium rounded-xl shadow-lg shadow-primary/25 hover:shadow-primary/40 transition-all duration-200 transform hover:-translate-y-0.5"
              >
                Log In
              </button>
            </form>
            ...
            <div className="grid grid-cols-2 gap-3">
              <button className="flex items-center justify-center gap-2 px-4 py-3 bg-[#121212] hover:bg-[#1a1a1a] border border-gray-800 rounded-xl transition-colors group">
