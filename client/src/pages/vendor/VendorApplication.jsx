    ...
    <div className="min-h-screen bg-[#050505] text-white font-sans selection:bg-violet-500/30">
      ...
      <main className="pt-32 pb-20 px-4 flex flex-col items-center">
            ...
            <form onSubmit={handleSubmit} className="space-y-10">
              ...
              <div className="space-y-6">
                ...
                <div className="space-y-2">
                  ...
                  <div
                    className="mt-2 flex justify-center px-6 pt-10 pb-10 border-2 border-white/5 border-dashed rounded-xl cursor-pointer hover:bg-white/5 hover:border-violet-500/50 transition-all group"
                    onClick={() =>
                      document.getElementById("businessDocumentUpload").click()
                    }
                  >
                    <input
                ...
                <div className="space-y-2">
                  ...
                  <div
                    className="mt-2 flex justify-center px-6 pt-6 pb-6 border-2 border-white/5 border-dashed rounded-xl cursor-pointer hover:bg-white/5 hover:border-violet-500/50 transition-all group"
                    onClick={() =>
                ...
                <div className="flex items-start gap-3 mt-4">
                  ...
                  <div className="text-sm">
                    ...
                    <p className="text-gray-500 mt-1 leading-relaxed">
                      ...
                      business information provided is accurate and you are
              ...
              <div className="flex flex-col-reverse md:flex-row items-center justify-between gap-4 pt-6 mt-6 border-t border-white/5">
                <button
                  type="button"
                  className="w-full md:w-auto px-6 py-3 text-sm font-medium text-gray-400 hover:text-white transition-colors"
                >
                  Cancel Application
                </button>
                <button
        ...
        <div className="mt-8 max-w-3xl w-full p-6 bg-[#0a0a0a] rounded-xl border border-white/5 shadow-lg flex items-start gap-4">
          ...
          <div>
            <h4 className="text-sm font-medium text-violet-400 mb-1 pointer-events-none">
              Application Process
            </h4>
            <p className="text-xs text-gray-500 leading-relaxed">
              Your application will be reviewed by our admin team within 2-3
