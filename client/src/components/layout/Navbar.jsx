        ...
        <>
            <nav className="fixed top-0 left-0 w-full z-40 bg-black/60 backdrop-blur-md transition-all duration-300 border-b border-white/5 py-4 px-6 md:px-10 flex items-center justify-between">
                ...
                <div className="flex items-center gap-3 sm:gap-4">
                    <button className="relative text-[#8A8F98] hover:text-white transition-colors outline-none cursor-pointer p-2 rounded-xl hover:bg-white/5">
                        <Bell className="w-5 h-5" fill="currentColor" />
                        <span className="absolute top-1.5 right-1.5 w-2 h-2 bg-[#ff3366] rounded-full border border-black"></span>
                    </button>
